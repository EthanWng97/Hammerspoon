...
hs.hotkey.bind({"alt",        "cmd"}, "Left",  hs.fnutils.partial(winresize, "left"))
hs.hotkey.bind({"alt",        "cmd"}, "Right", hs.fnutils.partial(winresize, "right"))
hs.hotkey.bind({"alt",        "cmd"}, "Up",    hs.fnutils.partial(winresize, "up"))
hs.hotkey.bind({"alt",        "cmd"}, "Down",  hs.fnutils.partial(winresize, "down"))
...
-- Maximized
hs.hotkey.bind({"alt",       "cmd"}, "return",     hs.fnutils.partial(winresize, "max"))
